...
public enum CryptoApi {
    ...
    XMR_USD_KRAKEN("https://api.kraken.com/0/public/Ticker?pair=XMRUSD",
            jsonObject -> ((JSONArray) ((JSONObject) ((JSONObject) jsonObject.get("result")).get("XXMRZUSD")).get(
                    "a")).get(0)),
    ...
    BTC_RUB_COINGECKO("https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=rub",
            jsonObject -> ((JSONObject) jsonObject.get("bitcoin")).get("rub")),
    LTC_RUB_COINGECKO("https://api.coingecko.com/api/v3/simple/price?ids=litecoin&vs_currencies=rub",
            jsonObject -> ((JSONObject) jsonObject.get("litecoin")).get("rub")),
    ...
    public static final List<CryptoApi> XMR_USD = List.of(CryptoApi.XMR_USD_BINANCE, CryptoApi.XMR_USD_KRAKEN);
