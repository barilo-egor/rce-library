...
public class AlfaTeamVTBRequisiteService extends AlfaTeamRequisiteService implements IMerchantRequisiteService {
    ...
    protected CreateInvoiceResponse createInvoice(Deal deal) throws Exception {
        return alfaTeamMerchantService.createInvoice(deal, Merchant.ALFA_TEAM_VTB, PaymentOption.SBP);
    }

    @Override
    protected boolean hasBinding(Deal deal) {
        return Objects.isNull(deal.getPaymentType().getAlfaTeamVTBPaymentOption());
    }
