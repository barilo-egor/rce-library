...
public enum MessageImage {
    ...
    INPUT_DEAL_SUM("Запрос ввода суммы(для ввода только в крипте)", "✅ Введите нужную сумму в %s.\n\uD83E\uDD16Оплата будет проверена автоматически."),
    INPUT_BITCOIN_DEAL_SUM("Запрос ввода суммы(для ввода в крипте/фиате)", "✅ Введите нужную сумму в %s или рублях.\n🤖Оплата будет проверена автоматически."),
    BUILD_DEAL_BUY("Формирование сделки покупки.", """
            ...
            <b>\uD83D\uDCB5Сумма к оплате</b>: <s>%s</s> <code>%s %s</code>
            ...
            %s
            ☑️После успешного перевода денег по указанным реквизитам нажмите на кнопку <b>%s</b> или же вы можете отменить данную заявку, нажав на кнопку <b>Отменить заявку</b>.
            %s"""),
    BUILD_DEAL_SELL("Формирование сделки продажи.", """
            ...
            %s"""),
    GETTING_REQUISITES("Ожидание получения реквизитов.", "Получение реквизитов. Пожалуйста, подождите."),
    ASK_FOR_RECEIPTS("Запрос чека.", "Отправьте скрин перевода, либо чек оплаты.")
    ;
