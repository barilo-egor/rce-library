...
public enum MessageImage {
    ...
    INPUT_DEAL_SUM("Запрос ввода суммы(не BTC)", "✅ Введите нужную сумму в %s.<ln>\uD83E\uDD16Оплата будет проверена автоматически."),
    INPUT_BITCOIN_DEAL_SUM("Запрос ввода суммы(для BTC)", "✅ Введите нужную сумму в %s или рублях.<ln>🤖Оплата будет проверена автоматически.")
    ;
