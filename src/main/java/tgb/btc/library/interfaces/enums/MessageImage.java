...
public enum MessageImage {
    ...
    BUILD_DEAL_SELL("Формирование сделки продажи.", """
            ...
            %s"""),
    ADDITIONAL_MERCHANT_BUILD_DEAL_TEXT("Дополнительный текст после реквизитов мерчанта.",
            """
                    ⚠️ВНИМАНИЕ:\s
                    ОПЛАЧИВАТЬ НУЖНО ТОЧНУЮ СУММУ, КАК УКАЗАНО В ЗАЯВКЕ ДО КОПЕЕК.\s
                    ИНАЧЕ ПРОВЕРКА ПЛАТЕЖА ЗАЙМЕТ ДОЛГОЕ ВРЕМЯ."""),
